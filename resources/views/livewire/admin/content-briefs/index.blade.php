    ...
    <x-ui.table caption="Content briefs">
        <x-ui.table-head>
            <tr>
                ...
                <x-ui.table-heading>
                    <button type="button" wire:click="sortBy('{{ $sort === 'approved_at' ? '-approved_at' : 'approved_at' }}')" class="inline-flex items-center gap-2 transition-colors hover:text-[var(--color-ink)]">
                        <span>Approved</span>
